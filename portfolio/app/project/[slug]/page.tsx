  ...
  return (
    ...
    <main className="w-full bg-slate-50 min-h-screen antialiased text-slate-600">
      ...
      <section className="w-full bg-[#0A192F] text-white py-12 text-center px-6">
        ...
        <button className="mt-5 bg-[#00E5FF] hover:bg-cyan-400 text-[#0A192F] text-xs font-bold uppercase tracking-wider px-6 py-3.5 rounded-full transition-all shadow-md cursor-pointer">
